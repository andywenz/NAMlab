...
class NetSecur:
    def __init__(self):
        self.vul_ports = {'21': 'FTP', '22': 'SSH', '23': 'TELNET', '25': 'SMTP', '53': 'DNS',
    ...
    def judge(self, atk_start, atk_end, other_vul_ports):
        score = total = 100
    ...
    def run(self):
        start, end = self.attacker()
        ports = self.defender()
        self.judge(start, end, ports)
